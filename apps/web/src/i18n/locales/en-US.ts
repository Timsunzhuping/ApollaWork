...
export const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'members.subtitle': 'Manage members of the current workspace and organization admins.',
  'members.workspace': 'Workspace members',
  'members.org': 'Organization members',
  'members.emailPlaceholder': 'Member email (must have signed in once)',
  'members.add': 'Add',
  'members.remove': 'Remove',
  'members.empty': 'No members yet',
  'members.you': '(you)',
  'members.readonlyHint': 'Only workspace owners or organization admins can manage members.',
  'members.selfHint': 'You cannot change your own organization role',
  ...
  // 策略中心（T-413）
  'policy.title': 'Policy center · approval rules',
  'policy.subtitle': 'Commands matching a rule require user approval. Built-in rules can only be toggled (audited); add org-wide or per-workspace custom rules, effective from the next task.',
  'policy.builtin': 'Built-in rules',
  'policy.custom': 'Custom rules',
  'policy.noCustom': 'No custom rules yet',
  'policy.patternPlaceholder': 'Regex, e.g. \\bscp\\b',
  'policy.reasonPlaceholder': 'Shown in the approval prompt',
  'policy.workspacePlaceholder': 'Restrict to workspace ID (empty = whole org)',
  'policy.add': 'Add rule',
  'policy.remove': 'Delete',
  'policy.scopedTo': 'workspace {id}… only',
  'policy.kind.bash_command': 'Command',
  'policy.kind.file_delete': 'Delete file',
  'policy.kind.file_overwrite': 'Overwrite file',
  'policy.kind.network_egress': 'Network egress',
  'admin.audit.exportCsv': 'Export CSV',
  'admin.audit.exportJsonl': 'Export JSONL',
  // API Key（T-419）与任务反馈（T-420）
  'apikey.title': 'Integration API keys',
  'apikey.subtitle': 'For IM bots, automation scripts and other systems — no more borrowing user tokens. Shown once; revoke anytime.',
  'apikey.issuedTitle': 'Issued — copy it now, it will not be shown again',
  'apikey.issuedHint': 'Send it in the x-api-key header (or Authorization: ApiKey <key>).',
  'apikey.issuedDone': 'Saved',
  'apikey.lastUsed': 'Last used {when}',
  'apikey.never': 'never',
  'apikey.expires': 'expires {when}',
  'apikey.revoked': 'Revoked',
  'apikey.revoke': 'Revoke',
  'apikey.empty': 'No API keys yet',
  'apikey.namePlaceholder': 'Name, e.g. "WeCom bot"',
  'apikey.daysPlaceholder': 'Valid days (optional)',
  'apikey.issue': 'Issue',
  'apikey.scope.tasks': 'Tasks',
  'apikey.scope.files': 'Files',
  'apikey.scope.admin': 'Admin',
  'admin.failures.export': 'Export failure samples',
  'task.rate.good': 'Good result',
  'task.rate.bad': 'Bad result',
  'task.rate.notePlaceholder': 'What went wrong? (optional)',
  'task.rate.submit': 'Submit',
  'task.rate.thanks': 'Recorded, thanks',
};
